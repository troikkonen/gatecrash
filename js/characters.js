...
// ============================================================
const MODELS = { soldier: 'models/Soldier.glb', xbot: 'models/Xbot.glb', robot: 'models/RobotExpressive.glb' };
const gltfs = {}, pools = {};
...
const charactersLoaded = Promise.all(['soldier','xbot','robot'].map(loadModel)).then(() => {
  pools.soldier = makePool('soldier', 40, { scale: 0.62, face: Math.PI });
